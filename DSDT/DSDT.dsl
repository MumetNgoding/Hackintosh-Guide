 ...
 *
 * Disassembly of DSDT.aml, Fri Jan 24 02:30:51 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010DB7 (69047)
 *     Revision         0x02
 *     Checksum         0x65
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    External (_SB_.PCI0.IDE0.PRT2.OFLG, IntObj)    // (from opcode)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (_Q0E, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            // Brightness Down
            Notify(\_SB.PCI0.LPCB.PS2K, 0x0365) //F5
        ...
        Method (_Q0F, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            // Brightness Up
            Notify(\_SB.PCI0.LPCB.PS2K, 0x0366) //F6
